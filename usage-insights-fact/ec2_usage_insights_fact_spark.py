...
df_joined_1=cpu_df.join(net_in_df,[cpu_df.instance_id==net_in_df.instance_id,cpu_df.metric_date==net_in_df.metric_date]).select(cpu_df.instance_id,cpu_df.metric_date,cpu_df.account_id,cpu_df.p95_cpu,cpu_df.p99_cpu,cpu_df.p90_cpu,cpu_df.p50_cpu,cpu_df.max_p99,cpu_df.avg_cpu,net_in_df.network_in)

df_joined_2=df_joined_1.join(net_out_df,[df_joined_1.instance_id==net_out_df.instance_id,df_joined_1.metric_date==net_out_df.metric_date]).select(df_joined_1.instance_id,df_joined_1.metric_date,df_joined_1.account_id,df_joined_1.p95_cpu,df_joined_1.p99_cpu,df_joined_1.p90_cpu,df_joined_1.p50_cpu,df_joined_1.max_p99,df_joined_1.avg_cpu,df_joined_1.network_in,net_out_df.network_out)
