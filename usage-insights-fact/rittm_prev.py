...
#datasource1 = glueContext.create_dynamic_frame.from_catalog(database = args['raw_database'], table_name = args['raw_table_second'], transformation_ctx = "datasource1",additional_options={"mergeSchema": "true"} )
...
df=athena_view_datasource.toDF()
#df=datasource0.toDF()
#df_second=datasource1.toDF()

#df=df.unionByName(df_second)
